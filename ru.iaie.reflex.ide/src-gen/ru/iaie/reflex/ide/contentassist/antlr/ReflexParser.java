...
public class ReflexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReflexGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getProgramAccess().getGlobalVarsAssignment_4_3(), "rule__Program__GlobalVarsAssignment_4_3");
			builder.put(grammarAccess.getProgramAccess().getRegistersAssignment_4_4(), "rule__Program__RegistersAssignment_4_4");
			builder.put(grammarAccess.getProgramAccess().getProcessesAssignment_4_5(), "rule__Program__ProcessesAssignment_4_5");
			...
			builder.put(grammarAccess.getStateAccess().getStateFunctionAssignment_4(), "rule__State__StateFunctionAssignment_4");
			builder.put(grammarAccess.getStateAccess().getTimeoutFunctionAssignment_5(), "rule__State__TimeoutFunctionAssignment_5");
			...
			builder.put(grammarAccess.getRegisterPortMappingAccess().getRegNameAssignment_0(), "rule__RegisterPortMapping__RegNameAssignment_0");
