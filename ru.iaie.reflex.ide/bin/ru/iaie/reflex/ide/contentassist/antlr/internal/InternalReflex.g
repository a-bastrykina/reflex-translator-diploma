...
:
	...
	|
	(
		{ before(grammarAccess.getPrimaryExpressionAccess().getINTEGERTerminalRuleCall_1()); }
		RULE_INTEGER
		{ after(grammarAccess.getPrimaryExpressionAccess().getINTEGERTerminalRuleCall_1()); }
	)
	|
	(
