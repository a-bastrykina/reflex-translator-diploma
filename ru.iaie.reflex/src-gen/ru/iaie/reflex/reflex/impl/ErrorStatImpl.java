 ...
 * </p>
 * <ul>
 *   <li>{@link ru.iaie.reflex.reflex.impl.ErrorStatImpl#getProcess <em>Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorStatImpl extends StatementImpl implements ErrorStat
{
    ...
    if (process != null && process.eIsProxy())
    {
      ...
      if (process != oldProcess)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReflexPackage.ERROR_STAT__PROCESS, oldProcess, process));
      }
    }
    return process;
  }
  ...
  public void setProcess(ru.iaie.reflex.reflex.Process newProcess)
  {
    ...
    process = newProcess;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ReflexPackage.ERROR_STAT__PROCESS, oldProcess, process));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReflexPackage.ERROR_STAT__PROCESS:
