...
public interface ReflexPackage extends EPackage
{
   ...
   * @ordered
   */
  int PHYSICAL_VARIABLE__SHARED = DECLARED_VARIABLE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int PROGRAM_VARIABLE__SHARED = DECLARED_VARIABLE_FEATURE_COUNT + 0;
