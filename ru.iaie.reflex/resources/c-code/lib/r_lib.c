...
INT16U Is_Error(INT16U pr_num)
{
    return (INT16U)(Check_State(pr_num) == STATE_OF_ERROR);
}

INT16U Is_Stop(INT16U pr_num)
{
    return (INT16U)(Check_State(pr_num) == STATE_OF_STOP);
}

INT16U Is_Active(INT16U pr_num) {
    return !Is_Stop(pr_num) && !Is_Error(pr_num);
}

INT8U  Is_Inactive(INT16U pr_num) {
    return Is_Stop(pr_num) || Is_Error(pr_num);
}
